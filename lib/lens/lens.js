		...
		(function() {
			...
			function i(t, e) {
				var n = j.length,
					...
					i = "constructor";
				for (w.has(t, i) && !w.contains(e, i) && e.push(i); n--;) i = j[n], i in t && t[i] !== r[i] && !w.contains(e, i) && e.push(i)
			}
			var s = this,
				a = s._,
				c = Array.prototype,
			...
			w.template = function(t, e, n) {
				...
				var o = RegExp([(e.escape || D).source, (e.interpolate || D).source, (e.evaluate || D).source].join("|") + "|$", "g"),
					r = 0,
					i = "__p+='";
